...
ALTER TABLE KHOA
ALTER COLUMN NGAYNHANCHUC DATE
ALTER TABLE KHOA
ALTER COLUMN NAMTL INT
...
ALTER COLUMN NGAYNHANCHUC DATE
ALTER TABLE BOMON
ALTER COLUMN PHONG VARCHAR(5)
ALTER TABLE BOMON
ALTER COLUMN DIENTHOAI VARCHAR(15)
-- Kết thúc tạo lược đồ quan hệ
...
-- Lược đồ CHUDE không có khóa ngoại để tham chiếu
-- Lược đồ KHOA
ALTER TABLE KHOA
...
-- ('009', '002', 3, 0.5, NULL),
-- ('009', '002', 4, 1.5, NULL)
-- SELECT * FROM THAMGIADT -- Câu lệnh để kiểm tra xem dữ liệu đã được thêm vào chưa
...
-- ('003', N'Nghiên cứu chế tạo sợi Nanô Plastin', N'ĐHQG', 300, '05-15-2008', '05-15-2010', 'NCPT', '005'),
...
-- ('002', N'Trần Trà Hương', 2500, N'Nữ', '06-20-1960', N'125 Trần Hưng Đạo, Q.1, TP HCM', NULL, 'HTTT'),
-- ('003', N'Nguyễn Ngọc Ánh', 2200, N'Nữ', '05-11-1975', N'12/21 Võ Văn Ngân, Thủ Đức, TP HCM', '002', 'HTTT'),
-- ('004', N'Trương Nam Sơn', 2300, N'Nam', '06-20-1959', N'215 Lý Thường Kiệt, TP Biên Hòa', NULL, 'VS'),
-- ('005', N'Lý Hoàng Hà', 2500, N'Nam', '10-23-1954', N'22/5 Nguyễn Xí, Q.Bình Thạnh, TP HCM', NULL, 'VLDT'),
-- ('006', N'Trần Bạch Tuyết', 1500, N'Nữ', '05-20-1980', N'127 Hùng Vương, TP Mỹ Tho', 004, 'VS'),
...
-- ('009', N'Trần Hoàng Nam', 2000, N'Nam', '11-22-1975', N'234 Trần Não, An Phú, TP HCM', '001', 'MMT'),
...
-- ('CNNT', N'Công nghệ tri thức', 'B15', '0838126126', NULL, 'CNNT', NULL),
...
-- ('VLUD', N'Vật lý ứng dụng', 'B24', '0838454545', '005', 'VL', '02-18-2006'),
